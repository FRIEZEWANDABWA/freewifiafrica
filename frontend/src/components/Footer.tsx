        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600">
              Bridging the digital divide across Sub-Saharan Africa through free public Wi-Fi, 
              educational content, and essential services for underserved communities.
            </p>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <p className="text-xs leading-5 text-gray-500">
              &copy; 2024 Connected Access Hubs. All rights reserved.
            </p>
